...
ColumnLayout {
  ...
  property int draftWidth: pluginApi?.pluginSettings?.widgetWidth ?? defaults.widgetWidth ?? 200
  property int draftSpeed: pluginApi?.pluginSettings?.scrollSpeed ?? defaults.scrollSpeed ?? 95
